...
st.title("AI-driven Robot Framework Test Case Generator")
...
def generate_test_case(test_type, input_text):
    ...
    if response.status_code == 200:
        ...
        error_message = f"Failed to generate test case. Status code: {response.status_code}, Response: {response.text}"
        print(error_message)  # This will print to your terminal running the Streamlit app
